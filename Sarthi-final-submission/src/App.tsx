...
type SafeIconProps = { icon?: any } & React.SVGProps<SVGSVGElement>;
function SafeIcon({icon: Icon, ...props}: SafeIconProps){
  if(!Icon || (typeof Icon !== 'function' && typeof Icon !== 'object')){
    return <span aria-hidden="true" style={{display:'inline-block',width:props.width||props.height||20,height:props.height||props.width||20}}/>;
  }
  try { return React.createElement(Icon, props); } catch {
    return <span aria-hidden="true" style={{display:'inline-block',width:props.width||props.height||20,height:props.height||props.width||20}}/>;
  }
}
